      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white/20 backdrop-blur-2xl rounded-3xl border-2 border-white/30 p-8 md:p-10 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* <button
              type="button"
              className="w-full bg-white hover:bg-gray-50 text-gray-800 px-6 py-3.5 rounded-2xl font-semibold transition-colors flex items-center justify-center gap-3 border-2 border-white/50"
            >
