-- Afganistan İlan Sitesi Veritabanı Yapısı

-- Veritabanı oluştur
CREATE DATABASE IF NOT EXISTS afganistan_ilanlar CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
('Elite Store - 3 Months', 'بسته پریمیوم - ۳ ماهه', 'elite', 3, 1197.00,
 ...
 JSON_OBJECT(
   ...
   'ozellikler', JSON_ARRAY(
     ...
     'قیمت عادی: ۱۷۱۰ افغانی',
     'قیمت با تخفیف: ۱۱۹۷ افغانی',
     '۱۵۰۰ افغانی اعتبار تبلیغاتی'
   )
 ))
ON DUPLICATE KEY UPDATE ad=ad;
